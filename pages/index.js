                      ...
                      <div className="item-slider-1">
                        <div className="box-content">
                          ...
                          <div className="box-custom">
                            <div className="wrap clr-pri-1">Sharon Springs School</div>
                            <svg
                              data-name="Hero Area"
            ...
            <div className="col-12">
              <div className="title-heading st-2">
                ...
                <h2 className="title clr-pri-1">
                  Discover Now Why People Come With Sharon Springs
                </h2>
              </div>
            </div>
            ...
            <div className="col-12">
              <div className="title-heading st-3">
                ...
                <h2 className="title clr-pri-2">
                  ...
                  <span className="clr-pri-3">Sharon Springs</span> Kindergarten
                </h2>
              </div>
            </div>
